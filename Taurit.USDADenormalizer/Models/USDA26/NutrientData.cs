namespace Taurit.USDADenormalizer.Models.USDA26
{
    ...
    public class NutrientData
    {
        ...
        /// <summary>
        ///     Standard error of the mean. Null if cannot be calculated. The standard error is also not given if the number of
        ///     data points is less than three.
        /// </summary>
        ...
        /// <summary>
        ///     NDB number of the item used to calculate a missing value. Populated only for items added or updated starting with
        ///     SR14.
        /// </summary>
        ...
        ///     breakfast cereals and many brand-name hot cereals in food group 8.
        /// </summary>
        ...
        ///     analytical quality control, and number of samples analyzed. Not included in this release, but is planned for future
        ///     releases.
        /// </summary>
